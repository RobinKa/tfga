...
class TestStaCayleyTensor(ut.TestCase):
    ...
    def test_sta_cayley_tensor_e12_e23_me13(self):
        ...
        self.assertTrue(np.all(cayley[e12_index, e23_index, e13_index + 1 :] == 0))
    ...
    def test_sta_cayley_tensor_e01_e23_e0123(self):
        ...
        self.assertTrue(np.all(cayley[e01_index, e23_index, :e0123_index] == 0))
        self.assertTrue(np.all(cayley[e01_index, e23_index, e0123_index + 1 :] == 0))
